...
<div class="container">
  <div class="row d-flex">
    ...
    <form action="<?php echo base_url('activities/update/'.$activity->id); ?>" method="post" class="row g-3">
      <!-- lessonid hidden -->
      ...
      <div class="col-md-2">
        ...
        <input type="number" class="form-control" id="activityNumber" name="activityNumber" min="1" value="<?php echo $activity->activityNumber; ?>" required>
      ...
      <div class="col-md-4">
        ...
        <select class="form-select" id="image" name="image" required>
          ...
          foreach($images as $img){
            ...
            if ($img['img_path'] == $activity->img_path) {
              echo " selected";
            }
      ...
      <div class="col-md-2">
        ...
        <input type="number" class="form-control" id="objectId" name="objectId" min="1" value="<?php echo $activity->objectId ; ?>" required>
        <div class="invalid-feedback">
      ...
      <div class="col-md-12">
        ...
        <input type="text" class="form-control" id="desc" name="desc" value="<?php echo $activity->descripcion ; ?>" required>
        <div class="invalid-feedback">
      ...
      <div class="col-md-12">
        ...
        <input type="text" class="form-control" id="url_resources" name="url_resources" value="<?php echo $activity->url_resources; ?>"  placeholder="-" >
        <div class="invalid-feedback">
          Please provide a valid city.
        </div>
      </div>
